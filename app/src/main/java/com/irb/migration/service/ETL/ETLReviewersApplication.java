...
public class ETLReviewersApplication implements IETL{
    ...
    public boolean StartETL() {
        ...
        users = null;
        // Transform data
        List<Reviewers> transformedData = eltFactoryTransformation.getTransformation("reviewersapp").TransformData(sourceData, usersMap, applicatinosMap);

        // Load data into destination
        destEM.getTransaction().begin();
        for (Reviewers destEntity : transformedData) {
